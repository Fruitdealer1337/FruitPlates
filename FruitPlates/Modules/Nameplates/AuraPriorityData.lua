...
FP.PriorityAuraData = {
    ...
    spells = {
        -- IMMUNITIES
        [642] = {type = "untouchable", priority = 1}, -- Divine Shield
        [8178] = {type = "importantdeff", priority = 1}, -- Grounding Totem Effect
        [19263] = {type = "importantdeff", priority = 1}, -- Deterrence
        [45438] = {type = "untouchable", priority = 1}, -- Ice Block
        [48707] = {type = "importantdeff", priority = 1}, -- Anti-Magic Shell
        [51690] = {type = "immunities", priority = 1}, -- Killing Spree
        [6615] = {type = "immunities", priority = 2}, -- Free Action
        [10278] = {type = "untouchable", priority = 1}, -- Hand of Protection
        [31224] = {type = "importantdeff", priority = 1}, -- Cloak of Shadows
        ...
        [6215] = {type = "cc", priority = 1}, -- Fear
        [10308] = {type = "cc", priority = 1}, -- Hammer of Justice
        ...
        [64843] = {type = "cc", priority = 1}, -- Divine Hymn
        [64901] = {type = "cc", priority = 1}, -- Hymn of Hope
        ...
        [5246] = {type = "cc", priority = 3}, -- Intimidating Shout
        ...
        [20511] = {type = "cc", priority = 3}, -- Intimidating Shout
        ...
        [17928] = {type = "cc", priority = 4}, -- Howl of Terror
        ...
        [63529] = {type = "silence", priority = 3, highlight = 4}, -- Shield of the Templar
        ...
        [23694] = {type = "roots", priority = 3}, -- Improved Hamstring
        ...
        [47585] = {type = "buffs_defensive", priority = 1}, -- Dispersion
        [498] = {type = "importantdeff", priority = 1}, -- Divine Protection
        ...
        [871] = {type = "importantdeff", priority = 1}, -- Shield Wall
        ...
        [3411] = {type = "importantdeff", priority = 1}, -- Intervene
        [5384] = {type = "buffs_defensive", priority = 4}, -- Feign Death
        [17116] = {type = "buffs_defensive", priority = 4}, -- Nature's Swiftness
        [33206] = {type = "importantdeff", priority = 1}, -- Pain Suppression
        [49039] = {type = "buffs_defensive", priority = 4}, -- Lichborne
        [2565] = {type = "importantdeff", priority = 1}, -- Shield Block
        [6940] = {type = "importantdeff", priority = 1}, -- Hand of Sacrifice
        -- [47484] = {type = "buffs_defensive", priority = 5}, -- Huddle
        [50461] = {type = "buffs_defensive", priority = 5}, -- Anti-Magic Zone
        [54428] = {type = "buffs_defensive", priority = 2, highlight = 1}, -- Divine Plea
        [1044] = {type = "buffs_defensive", priority = 6, highlight = 3}, -- Hand of Freedom
        [20230] = {type = "buffs_defensive", priority = 6}, -- Retaliation
        [18499] = {type = "buffs_defensive", priority = 7, highlight = 3}, -- Berserker Rage
        [64205] = {type = "importantdeff", priority = 1}, -- Divine Sacrifice
        ...
        [31884] = {type = "buffs_offensive", priority = 2}, -- Avenging Wrath
        ...
        [10060] = {type = "buffs_offensive", priority = 5, highlight = 1}, -- Power Infusion
        ...
        [47986] = {type = "importantdeff", priority = 1}, -- Sacrifice
