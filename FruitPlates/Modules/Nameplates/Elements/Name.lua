...
function NP:Update_Name(frame)
    ...
    if frame.Health:IsShown() then
        ...
        if name._fruitplatesLayoutPoint ~= "TOP"
            or name._fruitplatesLayoutParent ~= frame
            or name._fruitplatesLayoutRelPoint ~= "TOP"
            or name._fruitplatesLayoutX ~= 0
            or name._fruitplatesLayoutY ~= 0 then
            name:ClearAllPoints()
            name:SetPoint("TOP", frame, "TOP", 0, 0)
            name._fruitplatesLayoutPoint = "TOP"
            name._fruitplatesLayoutParent = frame
            name._fruitplatesLayoutRelPoint = "TOP"
            name._fruitplatesLayoutX = 0
            name._fruitplatesLayoutY = 0
        end
    end
